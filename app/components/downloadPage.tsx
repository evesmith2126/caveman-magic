  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.buttonGrid}>
        ...
        <a href="/downloads/caveman-magic-mac.zip" style={styles.button} className="download-btn">
          <span style={styles.icon}>🍎</span> Mac Download
        </a>

        <a href="/play" style={styles.button} className="download-btn">
          <span style={styles.icon}>🌐</span> Play in Browser
        </a>
      </div>
